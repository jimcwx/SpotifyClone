...
<div class="searchContainer">
  ...
  <input type="text" name="" id="" class="searchInput" value ="<?php echo $term ?>" placeholder="Start Typing...." onfocus="this.selectionStart = this.selectionEnd = this.value.length;">
</div>
